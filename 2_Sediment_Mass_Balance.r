...
#depo m/day * g/m3 --> g/m2d
  ...
  Vol_anox3<-1E+14
  POM_depo_1_day<-POM_depos$Anoxic3/1000
  silt_depo_1_day<-silt_depos$Anoxic3/1000
  fPOM<-mean(POMs$Anoxic3/TOTs$Anoxic3, na.rm=TRUE)
  fsilt<-mean(silts$Anoxic3/TOTs$Anoxic3, na.rm=TRUE)

depo_media1<-(POM_depo_1_day+silt_depo_1_day)/2  #1/day
mean(depo_media1)
...
PWhg1_ng<-PWhg1_ngL*PW1_L
PWhg2_ng<-PWhg2_ngL*PW2_L
PWhg1_g<-PWhg1_ng/10^9
PWhg2_g<-PWhg2_ng/10^9
PWhg1_kmol<-PWhg1_g/(200.59*1000)
PWhg2_kmol<-PWhg2_g/(200.59*1000)
tail (PWhg1_kmol)
tail (PWhg2_kmol)   
