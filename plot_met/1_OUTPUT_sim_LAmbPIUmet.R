...
setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L1')
L_base<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L2')
L_met_min<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L3')
L_met_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L4')
L_demet_min<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L5')
L_demet_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L6')
L_max_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb_piuDEM/L7')
...
er_mehg<-rowMeans(Errors_mehg_Lam_piu_DEM[1,]);er_sd_mehg<-sd(Errors_mehg_Lam_piu_DEM[1,])
er_hg<-rowMeans(Errors_hg_Lam_piu_DEM[1,]);er_sd_hg<-sd(Errors_mehg_Lam_piu_DEM[1,])
