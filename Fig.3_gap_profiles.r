...
gap.plot(medie$HS,medie$Density,ylim=c(13.25,15), xlim=c(0,0.9), pch=4,
         ...
         gap.axis="y",  xticlab=NA, cex.axis=1.6, cex=2)
...
text(0.35,11.2,"OL", adj=0, font=2,     cex=1.2)  
text(0.35,16-4,"SOL", adj=0, font=2,    cex=1.2)  
text(0.55,16.5-4,"UAOL", adj=0, font=2, cex=1.2) 
text(0.55,17.15-4,"DAOL", adj=0, font=2,cex=1.2)  
text(0.55,17.27-4,"BBL", adj=0, font=2, cex=1.2)  
...
legend(0.5,11, pch=c(21,22,24,23,25,8), bg='#FFFFFF', cex=1.8,
