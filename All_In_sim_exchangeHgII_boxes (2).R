...
HgT_OL_g_m3<-hgII$Oxycline/10^6    #OL4
HgT_SOL_g_m3<-hgII$Suboxic1/10^6      #  SOL
HgT_AOL_g_m3<-hgII$Suboxic2/10^6     # AOL1
HgT_BBL_g_m3<-hgII$Anoxic3/10^6  #AOL4
HgD_BBL_g_m3<-diss_hgII$Anoxic3/10^6 #AOL4
HgD_Sed_g_m3<-diss_hgII$Sed1/10^6      # sEd
...
write.csv(exchange, file='exchange_hgII.csv')
...
HgII_OL_g_m3<-hgII$Oxycline/10^6    #OL4
HgII_SOL_g_m3<-hgII$Suboxic1/10^6      #  SOL
HgII_AOL_g_m3<-hgII$Suboxic2/10^6     # AOL1
HgII_BBL_g_m3<-hgII$Anoxic3/10^6  #AOL4
HgD_BBL_g_m3<-diss_hgII$Anoxic3/10^6 #AOL4
HgD_Sed_g_m3<-diss_hgII$Sed1/10^6      # sEd
...
conc_grad1<-(HgII_SOL_g_m3-HgII_OL_g_m3) #g/m3
conc_grad2<-(HgII_AOL_g_m3-HgII_SOL_g_m3) #g/m3
conc_grad3<-(HgD_BBL_g_m3-(HgD_Sed_g_m3/0.95)) #g/m3
