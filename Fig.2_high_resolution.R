...
mtext("T \n (蚓)", 3, line=-0.6,at=1.5,col="darkgoldenrod1", cex=1.4)
...
mtext(expression(paste('HS'^-1)),side=1,line=-0.7,at=-90,col="#fb6a4a", cex=1.4)
mtext(expression(paste('(然)')),side=1,line=1.2,at=-100,col="#fb6a4a", cex=1.4)
...
mtext(expression(paste('Fe'[D])),side=1,
  line=-1,at=c(-110), col="#f49b42", cex=1.4)
mtext(expression(paste('(nM)')),side=1,
      line=.5,at=c(-110), col="#f49b42", cex=1.4)
...
mtext(expression(paste('Hg'[D])),side=3,
      line=0.4,at=-1.2,col="#3690c0", cex=1.4)
mtext(expression(paste('(pM)')),side=3,
      line=-1.3,at=-1.2,col="#3690c0", cex=1.4)


axis(2, at=y,line=0, col="black", cex.axis=1.6)
axis(2, at=y2,line=0,labels=F, col="black" , tck =-.02, cex.axis=1.6)
mtext(expression(paste(sigma[theta]*'  (kg m'^-3*')')), 2, line=2.3,
      at=13.5,col="black", cex=1.3)
...
mtext(expression(paste('MeHg'[D])),side=3,
      line=0.4,at=c(-.28),col="#df65b0", cex=1.4)
mtext(expression(paste('(pM)')),side=3,
      line=-1.3,at=c(-.28),col="#df65b0", cex=1.4)
