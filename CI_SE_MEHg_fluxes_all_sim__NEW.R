...
metnet_2013<-c(metnet_f6[164],metnet_f2[164],
          metnet_new2[164],metnet_new3[164])

pMeHgdepo_2013<-c(pMeHgdepo_f6[164],pMeHgdepo_f2[164],
                pMeHgdepo_new2[164],pMeHgdepo_new3[164])

metnet_2013<-c(metnet_f6[164],metnet_f2[164],
               metnet_new2[164],metnet_new3[164])

b1_2013<-c(bur1_f6[164],bur1_f2[164], 
           bur1_new2[164],bur1_new3[164])

b2_2013<-c(bur2_f6[164],  bur2_f2[164],
           bur2_new2[164],bur2_new3[164])

outf_2013<-c(outf_f6[164],outf_f2[164],
             outf_new2[164],outf_new3[164])

inf_2013<-c(inf_f6[164],inf_f2[164],
            inf_new2[164],inf_new3[164])

diff_2013<-c(diff_f6[164],diff_f2[164],
