...
setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L1')
L1_base<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L2')
L1_met_min<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L3')
L1_met_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L4')
L1_demet_min<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L5')
L1_demet_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L6')
L1_max_max<-read.table('mod_out.txt',header=T)

setwd('C:/Users/gi/Desktop/nuoveMEt2/Lamb/L7')
L1_min_min<-read.table('mod_out.txt',header=T)

MeHg<-data.frame(L1_base$dissMehg_pM,L1_met_min$dissMehg_pM, 
                 L1_met_max$dissMehg_pM,L1_demet_min$dissMehg_pM,
                 L1_demet_max$dissMehg_pM,  L1_min_min$dissMehg_pM,
                 L1_max_max$dissMehg_pM)

names(MeHg)<-c('b','metmin','metmax','demmin',
               'demmax','minmin','maxmax')

Errors_mehg_Lam<-data.frame(L1_base$RMSE, L1_met_min$RMSE, 
              L1_met_max$RMSE,  
              L1_demet_min$RMSE, L1_demet_max$RMSE,
              L1_min_min$RMSE,L1_max_max$RMSE)
names(Errors_mehg_Lam)<-c('b','metmin','metmax','demmin',
               'demmax','minmin','maxmax')
...
Hg<-data.frame(L1_base$disshg_pM, L1_met_min$disshg_pM, L1_met_max$disshg_pM,  
          L1_demet_min$disshg_pM, L1_demet_max$disshg_pM,
           L1_min_min$disshg_pM,
          L1_max_max$disshg_pM)
names(Hg)<-c('b','metmin', 'metmax', 'demmin',
                 'demmax', 'minmin', 'maxmax')

Errors_hg_Lam<-data.frame(L1_base$RMSE_hg, L1_met_min$RMSE_hg, L1_met_max$RMSE_hg,  
                 L1_demet_min$RMSE_hg, L1_demet_max$RMSE_hg,
                 L1_min_min$RMSE_hg,L1_max_max$RMSE_hg)
names(Errors_hg_Lam)<-c('b','metmin','metmax','demmin',
                 'demmax','minmin','maxmax')
...
segments(x1+sd1,y-epsilon,x1+sd1,y+epsilon, col='#5716a2')
polygon(zz2,yy,col='#b3db2544',border = NA)
#lines(x, y, lwd = 2, col='#748929')
#points(x, y, lwd = 2, col='#748929', cex=4, pch=23)
par(new=T)
plot(L1_base$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
plot(L1_min_min$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
plot(L1_max_max$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
plot(L1_met_min$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
plot(L1_met_max$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
plot(L1_demet_min$disshg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(1, 4))
par(new=T)
...
segments(x2+sd2,y-epsilon,x2+sd2,y+epsilon, col='#5716a2')
polygon(xx2,yy,col='#b3db2533',border = NA)
...
plot(L1_min_min$dissMehg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(0,1.3))
par(new=T)
plot(L1_max_max$dissMehg_pM,type='l', prof, xlab=' ',
     bty='n',lwd=2, cex=2,col='grey50',bg='#b3db2577',
     ylim=c(17.5,11), lty=3, pch=23,
     xlim=c(0,1.3))
par(new=T)
...
er_mehg<-rowMeans(Errors_mehg_Lam[1,]);er_sd_mehg<-sd(Errors_mehg_Lam[1,])
er_hg<-rowMeans(Errors_hg_Lam[1,]);er_sd_hg<-sd(Errors_hg_Lam[1,])

df1<-c(cor_hg,sd_cor_hg, cor_mehg, sd_cor_mehg, 
       er_hg,er_mehg, er_sd_mehg)
min(er_mehg)

write.table(df1, 'Errors_andcorr_lamb_noDEM.txt')



write.table(Errors, 'Mehg_errors_c.txt')
write.table(Errors_hg, 'Hg_errors_c.txt')
write.table(Hg, 'hg_conc_c.txt')
write.table(MeHg, 'mehg_conc_c.txt')
