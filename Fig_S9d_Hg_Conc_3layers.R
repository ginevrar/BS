...
par(new=TRUE)
plot(ax2,empty_v1, type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(0,4), bg='#0098cc',col='black')
par(new=TRUE)
plot(ax2,hgT$Suboxic1/215*1000, ylim=c(0,4), col="chartreuse3", lwd=2,
     ylab="   ", xlab="   ", xaxt='n', type="l",yaxt='n',lty=1) 
par(new=TRUE)
plot(ax2,empty_v2, type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(0,4), bg='chartreuse4',col='black')
par(new=TRUE)
...
par(new=TRUE)
plot(ax2,empty_v3, type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(0,4), bg='#800026',col='black')
text(1878,1.6,'OL',col='#0098cc', cex=1.7)
text(1980,1.8,'SOL',col='chartreuse4', cex=1.7)
text(2000,3.2,'AOL',col='#800026', cex=1.7)
dev.off()
