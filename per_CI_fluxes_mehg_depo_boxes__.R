...
mehgPOM_gm3<-hgCl_gm3*POMs_kgL*kd_POM
mehgsilt_gm3<-hgCl_gm3*silts_kgL*kd_silt

hgp<-(mehgPOM_gm3+mehgsilt_gm3)*10^6

Phg_OL <-Pmehgs$Oxycline; tail(Phg_OL) #ngL
hgp_OL <-hgp$Oxycline;   tail(hgp_OL)

str(hgp_OL)
str(Phg_OL)

hgPOM_ngL<-  mehgPOM_gm3*10^6
hgsilt_ngL<-  mehgsilt_gm3*10^6

tail(hgPOM_ngL$Oxycline)  
tail(hgsilt_ngL$Oxycline)

# hg ug/m3
Phg_OL <-Pmehgs$Oxycline
Phg_SOL <-Pmehgs$Suboxic1       # hg ug/m3
Phg_AOL <-Pmehgs$Anoxic3       # hg ug/m3
...
write.csv(depoohgp, file='depomehgp.csv')
