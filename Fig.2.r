...
plot(Clean_data$Temp, Clean_data$sigma,xlim=c(6,27),
     ...
     ylab=' ', cex.lab=1.8,
     xlab=" ", pch=24)
axis(3, at=a,line=0.3, col="darkgoldenrod1")
mtext("T \n (蚓)", 3, line=0.3,at=1.5,col="darkgoldenrod1", cex=0.9)
text(16,12,'OL', cex=.9, font=2)
text(22,14.7,'CIL', cex=.9, font=2)
text(14,15.9,'SOL', cex=.9, font=2)
text(14,16.7,'AOL', cex=.9, font=2)
#text(13,22,"1", col="red", cex=1)
par(new=TRUE)
summary(Clean_data$Sal)
s<-seq(17,23,by=1)
plot(Clean_data$Sal, cex=1.4, Clean_data$sigma, ylim=rev(range(Clean_data$sigma)), 
     pch=4, col="#80cdc1",frame=FALSE, xaxt='n',yaxt='n',xlab="",ylab="",
     xlim=c(17,23))
axis(1, at=s,line=.3, col="#35978f")
mtext("Sal",1, line=.5, col="#35978f", cex=0.9, at=15.5)
...
mtext(expression(paste(sigma[theta]*'  (kg/m'^3*')')), 2, line=2,at=13.5,col="black", cex=0.9)
#mtext("Sal",1, line=3, col="#35978f", cex=0.9, at=24)
...
plot(Ox$Ox_uM, Ox$sigma, ylim=rev(range(Clean_data$sigma)),
     col="#abd9e900", frame=FALSE, xlim=c(0,350),cex=1.4,
     xaxt='n', yaxt='n',xlab="", ylab='', 
     cex.lab=1.8, pch=8)
axis(3,line=0.3, col="#72b3c9",at=d)
Lines <- list(bquote('O'[2]),   bquote("(然)"))
mtext(do.call(expression, Lines),side=3,
      line=c(1,-0.3),at=-90,col="#72b3c9", cex=0.9)
...
par(new=T)       
plot(Ox$Ox_uM, Ox$sigma, ylim=rev(range(Clean_data$sigma)),
     col="#abd9e9",frame=FALSE, xlim=c(0,350),cex=1.4,
     xaxt='n',yaxt='n', xlab="", ylab=' ', cex.lab=1.8,pch=8)
...
axis(1,at=g,line=.3, col="#fb6a4a")
Lines <- list(bquote('HS'),   bquote("(然)"))
mtext(do.call(expression, Lines),side=1,
      line=c(-0.3,1),at=-90,col="#fb6a4a", cex=0.9)
axis(2, at=y,line=0, col="black" )
axis(2, at=y2,line=0,labels=F, col="black" , tck =-.02)#mtext(expression(paste(sigma[theta]*'  (kg/m'^3*')')),1, line=3, col="#35978f", cex=0.9, at=24)
mtext(expression(paste(sigma[theta]*'  (kg/m'^3*')')), 2, line=2,at=13.5,col="black", cex=0.9)
...
plot(Mn$Mn, Mn$sigma, ylim=rev(range(Clean_data$sigma)), xlim=c(0,5000), 
     col="#88419d00", bg="#d4b9da00", cex.lab=1.8, cex=1.4,
     frame=FALSE,xaxt='n',yaxt='n',  pch=24,xlab='',
     ylab='')
axis(1,at=e,line=.3, col="#e1e22f")
Lines <- list(bquote('Mn'[D]),   bquote("(nM)"))
mtext(do.call(expression, Lines),side=1,
      line=c(-0.3,1),at=-1400,col="#e1e22f", cex=0.9)
...
axis(3, at=ba,line=0.3, col="#006837")
mtext("BAC \n (1/m)",3,line=0,at=-.13, col="#006837", cex=0.9)

text(0.45,12,'OL', cex=0.9)
...
rect(0, 17.235 ,  5,17.25 , density = NULL, angle = 45, 
     ...
     xpd = NULL)      
par(new=T)
plot(no3$NO3, no3$sigma, cex=1.3,xlim=c(0,5), 
     col="#66bd63", lwd=1.3,frame=F, ylim=rev(range(Clean_data$sigma)),
     ylab='', cex.lab=1.8, xaxt='n',yaxt='n', xlab="", pch=4)
no3a<-seq(0,5,by=1)
axis(3,at=no3a,line=.3, col="#66bd63")
Lines <- list(bquote('NO'[3]), bquote("(然)"))
mtext(do.call(expression, Lines),side=3,
      line=c(1,-.4),at=c(-1.3), col="#66bd63", cex=0.9)
par(new=TRUE)
...
mtext(do.call(expression, Lines),side=1,
      line=c(-.7,.8),at=c(-150), col="#f49b42", cex=0.9)
axis(2, at=y,line=0, col="black" )
axis(2, at=y2,line=0,labels=F, col="black" , tck =-.02)
mtext(expression(paste(sigma[theta]*'  (kg/m'^3*')')), 2, line=2,at=14.5,col="black", cex=0.9)
...
plot(Clean_data$Hg, Clean_data$sigma, xlim=c(0,5),
     ...
     type="p",lty=4, col="#3690c000", cex=1.4,
     ylab='', main=" ",
     cex.lab=2, xlab=" " )
...
plot(Clean_data$Hg, Clean_data$sigma, xlim=c(0,5),
     ...
     type="p",lty=4, bg="#3690c088",col='#256486', cex=1.4,
     ylab='', main=" ",
     cex.lab=1.8, xlab=" " )
m<-seq(0,5,by=1)
axis(3,at=m,line=0.3, col="#3690c0")
Lines <- list(bquote('Hg'[D]),   bquote("(pM)"))
mtext(do.call(expression, Lines),side=3,
      line=c(1,-0.3),at=c(-1.2),col="#3690c0", cex=0.9)
...
plot(Clean_data$MeHg, Clean_data$sigma, xlim=c(0,1.2),xaxt='n', yaxt='n',
     ylim=rev(range(Clean_data$sigma)), pch=23, cex=1.4,
     type="p",lty=4, col="#df65b000", bg="#df65b000", main=" ",
     ylab='',cex.lab=1.8,xlab=" ")
...
par(new=T)   
plot(Clean_data$MeHg, Clean_data$sigma, xlim=c(0,1.2),xaxt='n', yaxt='n',
     ylim=rev(range(Clean_data$sigma)), pch=22, cex=1.4,
     type="p",lty=4, col="#e7298a", bg="#df65b088", main=" ",
     ylab='', cex.lab=1.8, xlab=" ")
axis(3,at=mm,line=0.3, col="#df65b0")

Lines <- list(bquote('MeHg'[D]),  bquote(" \n (pM)"))
mtext(do.call(expression, Lines),side=3,
      line=c(1,-0.3),at=c(-.35),col="#df65b0", cex=0.9)
axis(2, at=y,line=0, col="black" )
axis(2, at=y2,line=0,labels=F, col="black" , tck =-.02)
mtext(expression(paste(sigma[theta]*'  (kg/m'^3*')')), 2, line=2,at=13.5,col="black", cex=0.9)
