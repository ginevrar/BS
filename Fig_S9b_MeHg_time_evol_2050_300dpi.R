...
par(new=TRUE)
plot(ax2,empty_v, bg='chartreuse4' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
...
par(new=TRUE)
plot(ax2,empty_v2, bg='darkblue' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot ( diffusion_kmol_y, col="darkgoldenrod1", lwd=2, type="l",  ylim=c(-4,7), ylab= " ",
     yaxt='n', xaxt='n',xlab= " ")
par(new=TRUE)
plot(ax2,empty_v3, bg='darkgoldenrod' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)

plot ( Input_terms, col="black", type="l", lty=2, lwd=1, ylim=c(-4,7), ylab= " ",
     yaxt='n', xaxt='n',xlab= " ")
par(new=TRUE)
plot(ax2,empty_v4,  bg='grey90' ,col='darkgrey',type='p', xlab= " ", ylab= " ", pch=23, cex=3, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot ( mehg_prodotto_kmol_y, col="hotpink3", type="l", lty=1, 
     lwd=1, ylim=c(-4,7), ylab= " ", yaxt='n', xaxt='n',    xlab= " ")
par(new=TRUE)  
plot(ax2,empty_v5,  bg='hotpink4' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot (-depo_Pmehg_kmol_y,  col="orange",ylab=' ',
     type="l", xlab= " ",yaxt='n', xaxt='n', ylim=c(-4,7), lwd=1)
par(new=TRUE)
plot(ax2,empty_v6,  bg='darkorange' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot (-mehgT_outflow_kmol_y, col="darkblue", type="l",yaxt='n', xaxt='n', lwd=2,
      ylim=c(-4,7),xlab= " ", ylab= " ")
par(new=TRUE)
plot(ax2,empty_v7,  bg='darkblue' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.7, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot ( -Output_terms, col="black", type="l", lty=2, yaxt='n', xaxt='n',
     ylim=c(-4,7), xlab= " ", ylab= "", lwd=1)
par(new=TRUE)
plot(ax2,empty_v9,  bg='grey90' ,col='darkgrey',type='p', xlab= " ", ylab= " ", pch=23, cex=3, xaxt='n',yaxt='n', ylim=c(-4,7))
par(new=TRUE)
plot(ax2,empty_v3, bg='darkgoldenrod' ,col='black',type='p', xlab= " ", ylab= " ", pch=23, cex=2.5, xaxt='n',yaxt='n', ylim=c(-4,7))
