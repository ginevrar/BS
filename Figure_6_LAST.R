...
setwd('C:/Users/Ginevra/Desktop/nuoveMet2')
...
polygon(good_shape,yy,col='#E69F0055',border = '#E69F00')
...
plot(hg_buone[,9],type='b',pch=25, prof, ylab='',
     bty='n', cex=2.4, col='#4169E1',bg='#4169E133',yaxt='n',  
...
boxplot(sed,a_ord,col=c('#00000077','#E69F0099'), 
