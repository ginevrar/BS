...
rect(0, y-h, pos2, y+h, col=c('#fdd49e',"lightcyan2","lightcyan2",
                              ...
                              "lightcyan2"))
text(10,1, expression("Hg"[P]*~"Deposition"), cex=1.5)
text(10,.8, "to the Sediment", cex=1.5)
text(-10,3, expression("Hg"[P]*~"Deposition"), cex=1.5)
text(-10,2.8, "to the Sediment", cex=1.5)
text(-15,4.8, expression("Hg"[T]*~"Mediterranean Outflow"), cex=1.5)
#text(-7.50,4.7, expression("Outflow"), cex=1.5)
text(10,2.9,  expression("Hg"[T]*~"Rivers Load"), cex=1.5)
text(11,3.9,  expression("Hg"[T]*~"Azov Sea Load"), cex=1.5)
text(14,4.8, expression("Hg"[T]*~"Mediterranean Inflow"), cex=1.5)
#text(30,4.7, expression("Inflow"), cex=1.5)
text(9,1.9, expression("Hg"[D]*~"Diffusion"), cex=1.5)
text(-7,1.9, expression("Hg"[D]*~"Diffusion"), cex=1.5)
text(-8,.9, expression("Hg"[P]*~"Burial"), cex=1.5)
text(-10,5.9, expression("Hg"^0*~'Volatilization'), cex=1.5)
text(15,5.9, expression("Hg"^II*~'Atmospheric Deposition'), cex=1.5)
#title(expression("Hg"[T]*~"Budget in the Black Sea"), cex=1.5)
par(cex.axis=1.5, mex=0.5)
axis(1, at=ticks, labels=(ticks), pos=0)
tw <- 1.5*strwidth("neg")
segments(-31, 1.5, 31, 1.5, lty=2, col="gray50") 
text(-25,6.2, "Water", cex=1.7, font=4, col='cyan4')
